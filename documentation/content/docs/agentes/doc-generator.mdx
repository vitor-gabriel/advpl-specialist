...
- Carregar referencia `documentation-patterns` para templates
...
### Fase 2: Enriquecer
- Carregar referencia `protheus-reference` para consultar funcoes nativas detectadas
- Carregar referencia `protheus-business` se contexto do modulo for necessario
- Carregar referencia `embedded-sql` se houver consultas SQL presentes
