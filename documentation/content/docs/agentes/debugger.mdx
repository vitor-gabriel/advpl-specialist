...
### Fase 2: Diagnosticar
- Carregar referencia `advpl-debugging` para metodologia
...
| Categoria do erro | Primeira verificacao | Referencia |
|---------------|------------|-----------------|
...
| Lock de banco | Pareamento RecLock/MsUnlock | advpl-debugging reference.md |
