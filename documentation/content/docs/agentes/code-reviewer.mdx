...
6. **Usar regras estabelecidas** - Sempre referenciar as regras da referencia, nao opinioes avulsas
...
- Carregar referencia `advpl-code-review` para obter a metodologia de revisao
