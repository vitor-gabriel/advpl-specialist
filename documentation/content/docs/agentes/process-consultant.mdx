...
- Carregar referencia `protheus-business`
...
- Carregar referencia `protheus-reference` se o usuario precisar de detalhes sobre funcoes nativas
- Carregar referencia `advpl-code-generation` se o usuario quiser exemplos de codigo
- Carregar referencia `embedded-sql` se o usuario precisar de exemplos de consultas
