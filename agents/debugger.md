...
6. **Search TDN for unknown errors** - Consult TDN documentation for rare errors
...
- If unknown: Consult `skills/tdn-lookup/reference.md` e buscar no TDN usando a parte genérica da mensagem de erro (sem o nome da variável específica) para aumentar a chance de match.
